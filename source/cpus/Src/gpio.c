...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetPinPull(ST25R3916_IRQ_GPIO_Port, ST25R3916_IRQ_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(ST25R3916_IRQ_GPIO_Port, ST25R3916_IRQ_Pin, LL_GPIO_MODE_INPUT);
