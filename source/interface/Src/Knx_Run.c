...
//            WORD32 RefTime = API_KnxTm_GetTimeMs();
//            while(KnxTm_GetDelayMs( RefTime ) < 100);
//            API_KnxMem_WriteByte(KNX_SOFT_RESTART_FLAG_REF, 0x34);
//            KnxMem_WriteFinished();
//            static unsigned char flag;
//            flag = API_KnxMem_GetByte(KNX_SOFT_RESTART_FLAG_REF);
