...
#define VALUE_SERIAL_NUMBER               {GET_HIBYTE(VALUE_FACTORY_ID),GET_LOWBYTE(VALUE_FACTORY_ID),2,0,2,4}
...
#define KNX_SOFT_RESTART_FLAG_OFFSET 16
#define NFC_UID_DATA_OFFSET          17+100
#define PARA_END_OFFSET               512+17+100  /* 1 is the length of the last parameter(1byte) */
...
#define KNX_SOFT_RESTART_FLAG_REF            (APP_PARA_AREA_REF + KNX_SOFT_RESTART_FLAG_OFFSET)  /*  */
//#define NFC_UID_DATA_REF                     (APP_PARA_AREA_REF + NFC_UID_DATA_OFFSET)  /*  */
...
#define VALUE_REF_CO0                     (APP_RAM_BEGIN+0)                  /* Data pointer for CO #0 offset 1 byte */
#define VALUE_REF_CO1                     (APP_RAM_BEGIN+1)                  /* Data pointer for CO #1 offset 1 byte */
#define VALUE_REF_CO2                     (APP_RAM_BEGIN+2)                  /* Data pointer for CO #2 offset 4 byte */
#define VALUE_REF_CO3                     (APP_RAM_BEGIN+6)                  /* Data pointer for CO #3 offset 4 byte  */
#define VALUE_REF_CO4                     (APP_RAM_BEGIN+10)                  /* Data pointer for CO #4 offset 2 byte  */
#define VALUE_REF_CO5                     (APP_RAM_BEGIN+12)                  /* Data pointer for CO #5 offset 4 byte  */
#define VALUE_REF_CO6                     (APP_RAM_BEGIN+16)                 /* Data pointer for CO #6 offset 4 byte  */
#define VALUE_REF_CO7                     (APP_RAM_BEGIN+20)                  /* Data pointer for CO #7 offset 2 byte  */
#define VALUE_REF_CO8                     (APP_RAM_BEGIN+22)                  /* Data pointer for CO #8 offset 4 byte  */
#define VALUE_REF_CO9                     (APP_RAM_BEGIN+26)                  /* Data pointer for CO #9 offset 2 byte  */
#define VALUE_REF_CO10                    (APP_RAM_BEGIN+28)                 /* Data pointer for CO #10 offset 1 byte */
#define VALUE_REF_CO11                    (APP_RAM_BEGIN+29)                 /* Data pointer for CO #11 offset 2 byte */
#define VALUE_REF_CO12                    (APP_RAM_BEGIN+31)                 /* Data pointer for CO #12 offset 8 byte */
#define VALUE_REF_CO13                    (APP_RAM_BEGIN+39)                 /* Data pointer for CO #13 offset 14 byte */
#define VALUE_REF_CO14                    (APP_RAM_BEGIN+53)                 /* Data pointer for CO #14 offset 1 byte */
#define RAM_FLAGS_REF                     (APP_RAM_BEGIN+54)                 /* Start of co ram flags  */
