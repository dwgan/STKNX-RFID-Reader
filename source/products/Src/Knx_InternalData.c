...
{
         16,           /* actual address table length. */
    0x16, 0x02,             /* physical address      */
    ...
    0x10, 0x0d,             /* Grp. address,Index 13 */
    0x10, 0x0e,             /* Grp. address,Index 14 */
    0x10, 0x0f,             /* Grp. address,Index 15 */
    0x10, 0x10              /* Grp. address,Index 16 */
};
...
/* Grp. addr index. */        /* Co. No. */
         0x01,                   CHARGER_WORKING_STATUS_CO,
         0x02,                   CHARGER_CONNECT_STATUS_CO,
         0x03,                   CHARGING_ENERGY_TOTAL_CO,
         0x04,                   CHARGING_ENERGY_LAST_CO,
         0x05,                   CHARGED_TIME_CO,
         0x06,                   CHARGING_VOLTAGE_VALUE_CO,
         0x07,                   CHARGING_POWER_VALUE_CO,
         0x08,                   CHARGING_CURRENT_VALUE_CO,
         0x09,                   CHARGING_POWER_MAXIMUM_CO,
         0x0A,                   CHARGING_TIME_MAXIMUM_CO,
         0X0B,                   CHARGING_FAULT_ID_CO,
         0X0C,                   CHARGER_TEMPERATURE_OBJ_CO,
         0X0D,                   CHARGE_DATE_TIME_CO,
         0X0E,                   CHARGE_ID_CO,
         0X0F,                   CHARGER_STATUS_SETTING_CO,
         0x10,                   CHARGE_ID_CO
};
